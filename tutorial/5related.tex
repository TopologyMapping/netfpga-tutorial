...
Os projetos de desenvolvimento foram ganhando mais sofisticação dentro
...
camada IP. Normalmente, ferramentas como o \ssf{iptables} permitem a
...
manipular ou descartar pacotes. O projeto modifica o \ssf{iptables} e
...
O processo que executa em espaço de usuário se comunica por soquete com
...
através de chamadas de sistema \ssf{ioctl} entre o programa que executa
...
espaço do usuário, que irá gerar um evento \ssf{pkt\_in} e enviá-lo ao
controlador.
...
Ilustramos o módulo \ssf{output\_port\_lookup} do comutador OpenFlow na
...
\ssf{pcap} (via \ssf{tcpdump}). Após essa fase de moldagem dos fluxos,
